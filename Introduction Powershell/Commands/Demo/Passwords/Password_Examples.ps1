...
# GET PASSWORD form keepass
  $PathTokeepassDB      = "C:\Users\Markv\Documents\CloudStation\10_Git\IntroductionPowershell\Introduction Powershell\Commands\Passwords\TestDatabase.kdbx"
...
# Convert Back to plain password
  ...
  get-KeePassPassword -PathToDB $PathTokeepassDB -EntryToFind $Entryname | Convertto-SecureString -asPlainText -Force
