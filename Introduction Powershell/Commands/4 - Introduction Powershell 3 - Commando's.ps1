#========================================================================
# Generated On  : 05-07-2016 13:37
# Generated By  : Mark van de Waarsenburg
# Organization  : Sogeti
# Dagdeel       : 4
#========================================================================
...
################################################################################
 gwmi -list *network*
  gwmi win32_Networkadapterconfiguration | where {$_.ipaddress -ne $Null}
   gwmi win32_Networkadapterconfiguration | where {$_.ipaddress -ne $Null} | gm
    $ipconf = gwmi win32_Networkadapterconfiguration | where {$_.ipaddress -ne $Null}
 ...
 Get-WmiObject win32_operatingsystem | format-table @{Name='ComputerName';e={$_.CSname}},
...
#Sheet BackgroundJobs:
  ...
  Invoke-Command {get-eventlog security –newest 1000} –computer localhost, labdc01 -asjob -jobname eventlogs
  Get-Job
